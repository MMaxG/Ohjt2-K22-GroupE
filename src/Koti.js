        ...
        <body> 
          ...
          <section className="header">
            ...
            <div className="text-box">
              <h1>Tervetuloa</h1>
              <p>Selaa omia ja porukan matkoja, lisää tarinoita ja muokkaa niitä helposti. Matkakohteiden selaaminen ei ikinä ole ollut helpompaa :D <br></br>Kirjaudu sisään saadaksesi lisätoimintoja</p>
              <a href="/rekisteroidy" className="hero-btn">Rekisteröidy</a>
            </div>
          </section>
