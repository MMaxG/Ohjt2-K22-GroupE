...
import OmatLisaaTarina from './OmatLisaaTarina';
import { useState } from "react";

function OmatTarinat() {
    ...
    <div className="App">
      <html>
        ...
        <body>
          ...
          <div>
            {active === "FirstCard" && <Cards></Cards>}
            {active === "SecondCard" && <OmatLisaaTarina></OmatLisaaTarina>}
          </div>
